...
//                                         .ifPresent(card -> gain(player, card, Destination.DISCARD));
//                            }
//                        })
//                );
//    }
...
//                                    "m"::equals,
//                                    choice -> {
//                                        CardUtil.TriggerEffect(player,"Action Money", self, money);
//                                        return null;
//                                    },
//                                    ()-> {
...
//                                        if(toTrash!=null){
//                                            vi.trash(toTrash);
//                                            Optional<Card> toGained = player.chooseCardFromSupply("You can choose a card that cost the same as the card your oppenent trashed (" + toTrash.getCostValue() + ")", card -> card.getCostValue() == toTrash.getCostValue(), false);
//                                            toGained.ifPresent(card -> gain(vi, card, Destination.DISCARD));
//                                        }
//                                    }
//                            );
//                        })
...
//                                     .ifPresent(card -> {
//                                        player.trash(card);
//                                        CardUtil.gainFromSupply(player, "Choose a card costing exactly 1$ more that " + card + "(" + card.getCostValue() + 1 + "$ )", gained -> gained.isEqualWithBonus(card, 1) , Destination.HAND, false);
//                                    }
//                            );
//                        })
//                );
...
//                        .cardPlayedCondition((event, player) -> player == event.player && event.getCard().hasName("Copper"))
//                );
//    }
//    @Dominion_Card(extension = "Intrigue", pileType = PileType.VICTORY)
...
//                                        }
//                                    }
//                                        if(c!= null && c.getCostValue() >= 3){
//                                            player.log( vi.getName() + "Revealed Card : " + aside);
//                                            player.trash(c);
//                                            Card finalCard = c;
//                                            CardUtil.gainFromSupply(player, "Choose an card cost up (" + (c.getCostValue() - 2) +")", card -> card.isAtMostWithBonus(finalCard, -2), Destination.DISCARD, false);
//                                        }
...
//                        })
//                        .onCardPlayed((event, owner) -> {
//                            config.get().set("last_ID", event.id);
...
//                            );
//                        })
//                        .cardPlayedCondition((event, player) -> event.getCard().hasType(CardType.ATTACK) && player != event.player && !config.get().getValue("last_ID").equals(event.id))
//                );
//    }
//    @Dominion_Card(extension = "Intrigue")
