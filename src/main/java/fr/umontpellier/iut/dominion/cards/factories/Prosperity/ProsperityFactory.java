...
//                                     .ifPresent(card -> {
//                                        player.trash(card);
//                                        player.increment(Item.VICTORY_TOKEN, card.getCostValue()/2);
//                                    }
//                            );
//
...
//                        .afterGainCondition((event, player) -> player == event.player && event.getCard().hasType(CardType.ACTION) && event.isSameCard())
//
//                );
//    }
//    @Dominion_Card(extension = "Prosperity")
...
//                                                "Choose a card costing up " + (card.getCostValue()+3),
...
//                                            player.trash(card);
//                                            self.set("money", self.getValue("money").intValue() + card.getCostValue());
//                                        },
...
//                                () -> null
//                        ))
//                        .duringGainCondition((event, player) -> player == event.player)
//                        .stayInPlayCondition(checkLink)
//                );
//
//    }
...
//                                }
//                        ))
//                        .duringGainCondition((event, player) -> player == event.player && event.isSameCard())
//                );
//    }
//    @Dominion_Card(extension = "Prosperity")
