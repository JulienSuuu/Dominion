...
//                .setup(config -> config.simpleAction(draw_Action_Coffers));
//    }
//    @Dominion_Card(extension = CG)
...
//                .setup(config -> config.simpleAction(action_Coffer_Buy));
//    }
//    @Dominion_Card(extension = CG)
...
//                .setup(config ->
//                    config.simpleAction(draw_Action)
...
//                .setup(config ->{
//                    config.simpleAction(draw_Action_Buy);
...
//                                                .ifPresent(reward -> gain(player, reward, Destination.HAND));
//
//                                        ;});
//                        })
...
//                                        .ifPresent(card ->{
//                                            player.trash(card);
//                                            CardUtil.gainFromSupply(player, "Choose a card costing exactly " + (card.getCostValue()+1), c -> c.isEqualWithBonus(card, 1), Destination.DISCARD, false);
//                                        })
//                                ).repeat(2)
//                        )
//                );
...
//                                if(choice.get().getCostValue()==0)return;
//                                for(int i = 0; i < 2; i++){
//                                    CardUtil.gainFromSupply(player, "Choose " + (2-i) + " card(s) to gain costing up" + (choice.get().getCostValue()-1), card -> card.isAtMostWithBonus(choice.get(), -1)  ,Destination.DISCARD, false);
//                                }
//                            }
//                        })
//                        .overpaid((player, self) -> {
