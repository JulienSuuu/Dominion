...
//
//import static fr.umontpellier.iut.dominion.Player.Skills.GainSkillsKt.gain;
...
//                                .thenDo(victim -> gain(victim, victim.getCardFromSupply("Curse"), Destination.DISCARD))
//                                .end()
//                        )
...
//                                }
//                        })
//                        .cardPlayedCondition(((event, player) -> player != event.player && (event.getCard().hasName("Silver") || event.getCard().hasName("Gold"))))
//                );
//    }
//
//    @Dominion_Card(extension = "Seaside")
...
//                            p.chooseWhatToDoOpt("Veux tu écarter cette carte pour poser une malédiction sur une des pile de la réserve", List.of(self) ,Button.yesOrNo,false)
//                                    .filter("y"::equals)
//                                    .ifPresent(card -> logic.run());
//                        }));
//    }
//
//    /**
...
//                                    prov ->  p.chooseWhatToDoOpt("Reveal a Province ?", new ArrayList<>(), Button.yesOrNo,false)
//                                            .filter("y"::equals)
...
//                                    stock.forEach(c -> {
//                                        CardUtil.moveTo(player, () -> c, card -> null, Destination.HAND);
...
//                        .afterGainCondition((event, player) -> player.getGame().onTheRight(player, event.player) && activate.test(config.get()))
//        );
//    }
//    /**
...
//                                    "y"::equals,
//                                    isPresent ->{
//                                        view.forEach(card -> p.moveTo(card, Destination.DISCARD));
//                                        return null;
//                                    },
//                                    () -> {
//                                        chooseOrder.run();
...
//                            p.chooseWhatToDoOpt("Choix: Placez votre carte au dessus de votre pioche : " + card.getName() , List.of(card),  buttons, true)
//                                    .filter("y"::equals).ifPresent(s -> p.moveTo(card, Destination.DRAW));
//                        })
//        );
//    }
//
...
//                            CardUtil.gainFromSupply(player, "Choississez un trésor (maximum 6 pièces) ",
...
//                                    .ifPresent(card -> {
//                                        p.trash(card);
//                                        p.increment(Item.MONEY, card.getCostValue());
//                                    });
//                        })
//                );
//    }
...
//                                            .forEach(gold -> gain(p, gold, Destination.DRAW));
//                                    }
//                            }
//                        })
//                );
...
//                                        "y"::equals,
//                                        choice -> {
//                                            owner.moveTo(config.get(), Destination.DRAW);
//                                            return null;
//                                        },
//                                        () -> null
//                                );
