...
//import static fr.umontpellier.iut.dominion.cards.factories.FactorySupplyPileKt.getMixedCards;
...
//                        })
//                        .beforeCardPlayedCondition((event, player) -> event.player != player && event.getCard().hasType(CardType.ATTACK))
//                );
//    }
//    @Dominion_Card(extension = "Adventures")
...
//                        })
//                        .itselfGainCondition((event, player) -> event.isBuy() && player.getProperties(Properties.Cards_Bought).get() == 0)
//                );
//    }
//    @Dominion_Card(extension = "Adventures")
...
//
//                            List<Card> reveals = CardUtil.getTopCards(player, toTrash.getCostValue());
//
...
//                            CardUtil.gainFromSupply(vi, "Curse", Destination.DISCARD, false);
//                        })
//                        .duringGainCondition((event, player) -> event.player != player && event.isBuy() && activate.test(config.get()))
//                );
//    }
//    @Dominion_Card(extension = "Adventures")
...
//                                    .ifPresent(trash -> {
//                                        player.trash(trash);
//                                        CardUtil.gainFromSupply(player, "Choose a card costing up to " + (trash.getCostValue() + 1 ) + "$", card -> card.isAtMostWithBonus(trash, 1) , Destination.HAND, false);
//                                    })
//                        )
//                );
//    }
...
//                        .beforeCardPlayedCondition((event, player) -> player == event.player && event.getCard().hasType(CardType.ACTION))
...
//                .setup(config -> config
//                        .checkItselfBuy((event, card) -> event.player.updateDrawBonusValue(2))
//                );
//    }
//    @Dominion_Card(extension = "Adventures", pileType = PileType.EVENT)
...
//                        .checkItselfBuy((event, card) -> {
//                            Player player = event.player;
//                            player.getPersistentFlag(Flags.expedition).set(true);
//                        })
//                );
//    }
//    @Dominion_Card(extension = "Adventures", pileType = PileType.EVENT)
...
//                        })
//                        .duringGainCondition((event, player) -> event.player == player && event.notMoved() && event.isSameCard())
//
//                );
//    }
//
...
//        if("Page".equals(name)){
//            return Objects.requireNonNull(getMixedCards(CardType.ASIDE)).stream().filter(
